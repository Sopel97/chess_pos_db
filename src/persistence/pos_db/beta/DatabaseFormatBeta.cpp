...
namespace persistence
{
    namespace db_beta
    {
            ...
            )
        {
            ...
            ImportStats stats = importImpl(std::execution::par_unseq, pipeline, pgns, bucketSize, numWorkerThreads);
        ...
        )
        {
            ...
            for (auto& file : files)
            {
                ...
                {
                    Logger::instance().logError("Importing files other than PGN is not supported by db_beta.");
