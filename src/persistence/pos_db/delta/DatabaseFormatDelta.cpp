...
namespace persistence
{
    namespace db_delta
    {
        namespace detail
        {
            ...
            const MemoryAmount Partition::mergeMemory = cfg::g_config["persistence"]["db_delta"]["max_merge_buffer_size"].get<MemoryAmount>();
        ...
        const MemoryAmount Database::m_pgnParserMemory = cfg::g_config["persistence"]["db_delta"]["pgn_parser_memory"].get<MemoryAmount>();
